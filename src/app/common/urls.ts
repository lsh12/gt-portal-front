...
export const forum_topics_qna_delete = '/api/v1/topics/qna/delete';
...
export const forum_topics_guide_delete = '/api/v1/topics/guide/delete'

export const forum_topics_document_detail = '/api/v1/topics/document/detail'
export const forum_topics_document_delete = '/api/v1/topics/document/delete'
